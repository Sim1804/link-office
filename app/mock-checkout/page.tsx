          ...
          <div className="card" style={{ padding: "40px 30px", overflow: "hidden", position: "relative" }}>
            ...
            <div style={{ textAlign: "center", marginBottom: 30 }}>
              <div style={{ 
                ...
                background: "linear-gradient(135deg, rgba(0,169,157,0.15) 0%, rgba(6,182,212,0.15) 100%)",
            ...
            <div style={{ 
              ...
              <div style={{ display: "flex", justifyContent: "space-between", alignItems: "center", marginBottom: 12 }}>
                <span style={{ color: "var(--text-2)", fontWeight: 500 }}>Montant à régler</span>
                <span style={{ fontSize: 24, fontWeight: 800, color: "var(--text-1)" }}>{amount}€</span>
              </div>
            ...
            <form onSubmit={(e) => { e.preventDefault(); handlePay(); }}>
              ...
              <button
                ...
                style={{
                  ...
                  background: loading ? "var(--text-3)" : "linear-gradient(135deg, var(--primary), #0ea5e9)",
                  color: "white", fontSize: 16, fontWeight: 700, 
                  cursor: loading ? "not-allowed" : "pointer",
                  display: "flex", justifyContent: "center", alignItems: "center", gap: 10,
                  transition: "all 0.2s",
                  boxShadow: "0 10px 25px rgba(0,169,157,0.25)"
                }}
              >
                {loading ? (
                  <>
            ...
            <div style={{ display: "flex", alignItems: "center", justifyContent: "center", gap: 8, marginTop: 24, color: "var(--text-3)", fontSize: 12 }}>
              <ShieldCheck size={14} />
...
export default function MockCheckoutPage() {
  return (
    <Suspense fallback={<div style={{ minHeight: "100vh", display: "flex", alignItems: "center", justifyContent: "center", color: "var(--text-2)" }}>Chargement...</div>}>
      <MockCheckoutContent />
    </Suspense>
  );
}
