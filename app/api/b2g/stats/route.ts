/**
 * @file route.ts
 * @module app/api/b2g/stats
 * @description Route API de l'Observatoire Territorial — statistiques agrégées pour les collectivités.
 *
 * Accessible uniquement aux administrateurs de collectivités (ADMIN_B2G, SUPER_ADMIN).
 ...
 * @throws {403} Si l'utilisateur n'est pas ADMIN_B2G ou SUPER_ADMIN
 * @throws {404} Si l'administrateur n'est associé à aucune collectivité
 *
 * @see app/dashboard/b2g/page.tsx — Dashboard qui consomme ces données
 */
