    ...
    <>
      ...
      <main style={{ minHeight: "100vh", background: "#0b0f19", paddingTop: 88, paddingBottom: 64, position: "relative" }}>
        ...
        <div style={{ maxWidth: 1000, margin: "0 auto", padding: "0 24px", position: "relative", zIndex: 1 }}>
          <button onClick={() => router.push('/dashboard/b2g')} style={{ display: "flex", alignItems: "center", gap: 8, color: "#94a3b8", background: "none", border: "none", cursor: "pointer", marginBottom: 24, fontSize: 14 }}>
          ...
          <div style={{ display: "flex", alignItems: "center", justifyContent: "space-between", marginBottom: 32 }}>
            ...
            <button 
              onClick={() => router.push('/dashboard/b2g/campaigns/create')}
                ...
                return (
                  <div key={camp.id} style={{ background: "rgba(17,24,39,0.7)", backdropFilter: "blur(12px)", border: "1px solid rgba(255,255,255,0.08)", borderRadius: 16, padding: 24, display: "flex", flexDirection: "column", gap: 0 }}>
                    ...
                    <div style={{ display: "flex", flexWrap: "wrap", gap: 8 }}>
                      ...
                      <button
                        onClick={() => router.push(`/dashboard/b2g/campaigns/${camp.id}`)}
                      ...
                      <button
                        onClick={() => router.push(`/dashboard/b2g/campaigns/${camp.id}/config`)}
                      ...
                      <button
                        onClick={() => router.push(`/dashboard/b2g/campaigns/${camp.id}/renew`)}
