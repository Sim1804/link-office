...
export default function NewMediaPage() {
  ...
  const [form, setForm] = useState({
    ...
    duration: "",
    published: false,
    content: "<h2>Introduction</h2><p>Commencez à rédiger ici...</p>",
    transcript: "",
  });
  ...
  const handleSubmit = async (e: React.FormEvent) => {
    ...
    const res = await createMediaContent(form);
    ...
    <div style={{ paddingBottom: 60 }}>
      ...
      <div style={{ display: "flex", justifyContent: "space-between", alignItems: "center", marginBottom: 32 }}>
        <div>
          ...
          <p style={{ color: "#94a3b8", marginTop: 8 }}>Ajoutez un nouvel article, podcast ou dossier dans le CMS.</p>
        </div>
      </div>
        ...
        <div style={{ flex: "1 1 300px", maxWidth: 400, display: "flex", flexDirection: "column", gap: 24, position: "sticky", top: 100 }}>
          ...
          <div className="card" style={{ padding: 32 }}>
            ...
            <label style={{ display: "flex", alignItems: "center", gap: 12, cursor: "pointer", marginBottom: 24, padding: 12, background: "rgba(0,0,0,0.15)", borderRadius: 6, border: "1px solid rgba(255,255,255,0.05)" }}>
              ...
              <span style={{ color: "#f8fafc", fontWeight: 500, fontSize: 14 }}>Publier immédiatement</span>
            </label>
