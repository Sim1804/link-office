        ...
        <div style={{ maxWidth: 760, margin: "0 auto", position: "relative", zIndex: 1 }}>
          ...
          {step === 1 && (
            <div style={{ display: "flex", flexDirection: "column", gap: 20 }}>
              <p style={{ color: "var(--text-3)", fontSize: 14, lineHeight: 1.7, background: "rgba(124,58,237,0.07)", border: "1px solid rgba(124,58,237,0.15)", borderRadius: 12, padding: "14px 18px" }}>
                <Info size={14} style={{ display: "inline", marginRight: 6, color: "var(--primary)" }} />
                En B2B2C, vous ne pouvez proposer que les offres PREMIUM ou PREMIUM+.
              </p>

              {[
                { id: "PREMIUM", icon: Zap, color: "var(--primary)", border: "#7c3aed", bg: "rgba(124,58,237,0.12)",
            ...
            <div className="card">
              ...
              <div style={{ display: "flex", flexDirection: "column", gap: 18 }}>
                <div>
                  ...
                  <input type="text" required value={form.title} onChange={e => setForm(f => ({ ...f, title: e.target.value }))} placeholder="Ex: Baromètre 2024" className="input-field" />
                </div>
                <div>
                ...
                <div>
                  <label style={{ display: "block", fontSize: 12, fontWeight: 600, color: "var(--text-3)", marginBottom: 6 }}>Population cible (quota financé)</label>
              ...
              <div className="card">
                ...
                <div style={{ display: "flex", flexDirection: "column", gap: 10 }}>
                  {CAMPAIGN_VARIABLES_LIBRARY.map(v => (
                    <label key={v.id} style={{ display: "flex", alignItems: "flex-start", gap: 12, cursor: "pointer", padding: "12px 14px", borderRadius: 12, border: `1px solid ${selectedVars.includes(v.id) ? "rgba(124,58,237,0.4)" : "var(--surface-2)"}`, background: selectedVars.includes(v.id) ? "rgba(124,58,237,0.08)" : "transparent", transition: "all 0.2s" }}>
                ...
                <div style={{ marginTop: 16 }}>
                  ...
                  <input type="text" value={customVar} onChange={e => setCustomVar(e.target.value)} placeholder="Ex: Avez-vous déjà bénéficié de nos services d'action sociale ?" className="input-field" />
                </div>
              </div>
