      ...
      <main className="page-main">
        ...
        <div style={{ maxWidth: 760, margin: "0 auto", position: "relative", zIndex: 1 }}>
          ...
          <div style={{ display: "flex", alignItems: "center", gap: 12, marginBottom: 32 }}>
            <Link href="/dashboard/b2b2c/campaigns" style={{ color: "#64748b", display: "flex", alignItems: "center", gap: 4, textDecoration: "none", fontSize: 13 }}>
          ...
          {step === 2 && (
            <div className="card">
              ...
              <div style={{ display: "flex", flexDirection: "column", gap: 18 }}>
                ...
                <div>
                  <label style={{ display: "block", fontSize: 12, fontWeight: 600, color: "#94a3b8", marginBottom: 6 }}>Population cible (quota financé)</label>
