        ...
        <div className="page-container-wide" style={{ position: "relative", zIndex: 1 }}>
          ...
          <div style={{ display: "flex", justifyContent: "space-between", alignItems: "center", marginBottom: 32, flexWrap: "wrap", gap: 16 }}>
            <div>
              ...
              <p style={{ color: "var(--text-2)", marginTop: 8, fontSize: 16 }}>Transformez les vulnérabilités de vos assurés en actions concrètes et suivez leur avancement.</p>
            </div>
                          ...
                          <div key={action.id} className="card" style={{ padding: 16, display: "flex", flexDirection: "column", gap: 12, background: "var(--surface)" }}>
                            <div style={{ display: "flex", justifyContent: "space-between", alignItems: "flex-start", gap: 12 }}>
                              ...
                              <div style={{ display: "flex", gap: 4 }}>
                                ...
                                <DeleteConfirmButton endpoint={`/api/actions/${action.id}`} onSuccess={() => setActions(prev => prev.filter(a => a.id !== action.id))} />
                              </div>
                            </div>
