...
import {
  ...
  Activity, BarChart3, Target, PieChart as PieChartIcon, User, Briefcase, Sparkles, HeartPulse, Lightbulb
} from "lucide-react";
import {
          ...
          <div style={{ display: "flex", justifyContent: "space-between", alignItems: "flex-end", marginBottom: 32, flexWrap: "wrap", gap: 16 }}>
            ...
            <div style={{ display: "flex", flexDirection: "column", alignItems: "flex-end", gap: 16 }}>
              ...
              <div style={{ display: "flex", gap: 8, flexWrap: "wrap" }}>
                <Link href="/dashboard/b2b2c/campaigns" className="btn btn-tertiary btn-sm">
                  Gérer les campagnes
                </Link>
                <Link href="/dashboard/b2b2c/actions" className="btn btn-primary btn-sm">
                  Plan d'action
                </Link>
              </div>
            </div>
            ...
            <div style={{ display: "flex", flexDirection: "column", gap: 24, animation: "fadeSlideIn 0.4s ease-out" }}>
              ...
              <div style={{ display: "grid", gridTemplateColumns: "repeat(auto-fit, minmax(280px, 1fr))", gap: 24 }}>
                ...
                <div className="card" style={{ display: "flex", alignItems: "center", gap: 20, padding: 24 }}>
                  ...
                  <div>
                    <p style={{ fontSize: 13, fontWeight: 700, color: "var(--text-3)", textTransform: "uppercase", marginBottom: 4 }}>Assurés Évalués</p>
                      ...
                      <div style={{ width: "100%", height: 300 }}>
                        <ResponsiveContainer>
                          <PieChart>
                            ...
                            <RechartsTooltip formatter={(v) => `${v} assuré(s)`} contentStyle={{ borderRadius: 8, border: "1px solid var(--border)", fontSize: 12 }} />
                            <Legend />
                          </PieChart>
                        </ResponsiveContainer>
                      </div>
                        ...
                        <ResponsiveContainer width="100%" height="100%">
                          <BarChart data={weatherData} layout="vertical" margin={{ left: 10, right: 20, top: 0, bottom: 0 }}>
                            ...
                            <RechartsTooltip 
                              ...
                              formatter={(value: number) => [`${value} assuré(s)`, "Quantité"]}
                            />
                ...
                <div style={{ display: "grid", gridTemplateColumns: "1fr 1fr", gap: 24 }}>
                  ...
                  <div className="card" style={{ padding: 32, gridColumn: "span 2" }}>
                    <div style={{ display: "flex", alignItems: "center", gap: 8, marginBottom: 24 }}>
                      ...
                      <h3 style={{ color: "var(--text-1)", fontWeight: 700, fontSize: 18, margin: 0 }}>Besoins Dominants des Assurés</h3>
                    </div>
                           ...
                           <div>
                              <div style={{ display: "flex", justifyContent: "space-between", alignItems: "flex-start", gap: 16, marginBottom: 8 }}>
                                ...
                                <button 
                                  ...
                                  style={{ whiteSpace: "nowrap", ...(addedActionIds.includes(rec.id) ? { background: "rgba(16,185,129,0.1)", color: "#34d399", border: "1px solid rgba(16,185,129,0.3)" } : {}) }}
                                >
