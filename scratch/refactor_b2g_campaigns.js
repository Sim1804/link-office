        ...
        <div className="page-container-wide" style={{ position: "relative", zIndex: 1 }}>
          ...
          <div style={{ display: "flex", alignItems: "center", gap: 16, marginBottom: 36 }}>
            ...
            <div style={{ marginLeft: "auto", display: "flex", gap: 10 }}>
              <Link href="/dashboard/b2g" className="btn btn-secondary btn-sm">
                Vue d'ensemble B2G
              </Link>
...
fs.writeFileSync('d:\\Projects\\link-office\\app\\dashboard\\b2g\\campaigns\\page.tsx', content);
console.log('Successfully aligned b2g campaigns page design with b2b2c.');
